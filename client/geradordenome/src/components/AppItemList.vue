              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="input-group">
                        <input class="form-control" type="text" v-model="item" v-on:keyup.enter="addItem(item)" placeholder="Digite o prefixo">
                        <div class="input-group-append">
                          <button class="btn btn-info" v-on:click="addItem(items)"><span class="fa fa-plus"></span></button> 
                        </div>
                  </div>
